  ...
  return (
    <header className="mb-8">
      <nav className="flex mb-3" aria-label="Breadcrumb">
        <ol className="flex flex-wrap items-center space-y-1 md:space-y-0">
            ...
            >
              ...
              >
                <path
                  ...
                  strokeWidth="2"
                  d="m4 12 8-8 8 8M6 10.5V19a1 1 0 0 0 1 1h3v-3a1 1 0 0 1 1-1h2a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h3a1 1 0 0 0 1-1v-8.5"
                />
              </svg>
              Dashboard
            </Link>
      ...
      <h2 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-3xl md:text-4xl leading-tight wrap-break-word">
        {title}
      </h2>
    </header>
  );
