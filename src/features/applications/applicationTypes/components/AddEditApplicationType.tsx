        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between gap-3 pt-6 border-t border-gray-100 dark:border-gray-700">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2.5 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg shadow-sm disabled:opacity-70 transition-all active:scale-95"
            >
              {isAdding || isUpdating ? (
              ...
              <span>
                {isAdding || isUpdating ? (
                  ...
                  <>
                    ...
                    <span className="sm:ms-1">Application Type</span>
                  </>
                )}
              </span>
            </button>
