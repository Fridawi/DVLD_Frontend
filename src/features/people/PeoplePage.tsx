...
function PeoplePage() {
  ...
  const people = pagedResult?.data || [];
  const breadcrumbPaths = [{ label: "People" }];
  ...
  const filterOptions: FilterOption[] = [
    ...
    { label: "Phone Number", value: "phone", type: "text" },
    { label: "Nationality", value: "nationality", type: "text" },
  ];
  return (
    <div className="flex flex-col gap-6">
      <PageHeader title="People Management" breadcrumbs={breadcrumbPaths} />
