...
export default function LicenseClassesPage() {
  ...
  const licensesClass = pagedResult?.data || [];
  const breadcrumbPaths = [{ label: "Licenses Class" }];
  ...
  const filterOptions: FilterOption[] = [
    { label: "License Class ID", value: "licenseclassid", type: "text" },
  ...
  return (
    <div className="flex flex-col gap-6">
      <PageHeader
        title="Licenses Class Management"
      ...
      <main className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
        <div className="min-h-100 flex flex-col">
          ...
          {isSuccess && (
            ...
            >
              <LicensesClassTable licensesClass={licensesClass} />
              {licensesClass.length === 0 && !isFetching && (
                <div className="py-20 text-center text-gray-500">
                  No Licenses Class found matching your search.
                </div>
              )}
            </div>
          )}
